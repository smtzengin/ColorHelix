...
public class Level : MonoBehaviour
{
    ...
    {
        checkLevel = PlayerPrefs.GetInt("Level");
        //color = Ball.GetBallColor();
        color = Color.Lerp(Color.blue, Color.cyan, 1f);
        ...
        if (checkLevel % 5 == 1)
        {
            color = Color.Lerp(Color.red, Color.green, 1f);
        }
        if (checkLevel % 5 == 2)
        {
        ...
        if (checkLevel % 5 == 3)
        {
            color = Color.Lerp(Color.magenta, Color.yellow, 1f);
        }
